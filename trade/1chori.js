...
function coinUSDList() {
  ...
  viewCoin.forEach((coin, index) => {
    ...
    int10 = setInterval(() => {
      ...
      document.querySelector(`.won-tab [data-id='${val10}'] .currentPrice .priceGroup`).innerHTML = `${randomPrice} KRW`;
      document.querySelector(`.dollar-tab [data-id='${val10}'] .currentPrice .priceGroup`).innerHTML = `${(randomPrice / 1320).toFixed(3)} USDT`;
...
document.querySelector(".won-tab").addEventListener("click", function(id){
